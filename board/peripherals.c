...
- name: BOARD_InitPeripherals
  UUID: 49ea74a8-56ef-48c7-bee8-0946ab56aee8
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: d7927275-edbe-4543-b534-209339ebe689
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: f236c00b-70e5-4c07-a7e0-016d15e7f32f
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: 23c5bfda-a6eb-4eb2-92ef-1ee42d2de649
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: b20f1803-e2e8-4eab-9ce3-5d5315708771
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: 29868800-7d4f-4cdc-9dee-527f619a7f27
  id_prefix: BOARD_
  selectedCore: core0
